 ...
 * @since 1.0.0
 */
class Tank_Post_List extends Widget_Base {
	...
	public function get_title() {
		return __( 'Tank Post List', 'tank-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Select post list layout.', 'tank-plugin' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Enable/ Disable post list alternative layout.', 'tank-plugin' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
	...
	protected function render() {
		...
		?>
		<div class="portfolio-list-item <?php echo esc_attr($tank_class);?> ">
		<div class="pli-inner">
